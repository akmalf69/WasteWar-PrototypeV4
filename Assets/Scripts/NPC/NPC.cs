...
public class NPC : MonoBehaviour
{
    ...
    [SerializeField] private string projectileTargetTag = "Enemy"; // Tag of the projectile's target
    ...
    private void Attack()
    {
        if (grapeProjectilePrefab != null)
        {
            ...
            {
                grapeProjectile.Initialize(projectileDamage, projectileTargetTag);
            }
            else
            {
                Debug.LogError("Grape projectile prefab does not have GrapeProjectile component.");
            }
        }
        else
        {
            Debug.LogError("Grape projectile prefab is not assigned.");
        }
    }
    */
    private void Attack()
